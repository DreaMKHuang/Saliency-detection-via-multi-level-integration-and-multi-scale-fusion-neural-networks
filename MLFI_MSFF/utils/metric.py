...
class ConfusionMatrix(object):
    ...
    def jaccard(self):
        ...
        for i in xrange(self.nclass):
            if not self.M[i, i] == 0:
                ...
                lengh_of_jaccard_perclass = len(jaccard_perclass)
                
            else:
                lengh_of_jaccard_perclass = self.nclass ** 2
                
        return np.sum(jaccard_perclass)/lengh_of_jaccard_perclass, jaccard_perclass, self.M
    ...
    def generateM(self, item):
        ...
        for i in range(len(gt)):
            ...
            if  gt[i] == 1 or pred[i] == 1: # 2 classes
                m[gt[i], pred[i]] += 1.0
        return m
